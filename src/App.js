...
export default function App() {
  ...
  <a className="navbar-brand" href=""><img id="logo" src="woodcutLogo.png" alt="" /></a>
...
{/* <!-- GRID --> */}
 ...
 <div className="grid-container">
  ...
  <div className="grid-item">
      ...
      <div><img id="avatar" src="" alt="avatar" /></div>
      <div><h1 id="username"> </h1></div>
      <div id="profile-info" className="grid-profile">
          
          <div className="grid-item-prof"><p>RuneScore:</p></div>
          <div className="grid-item-prof"> <img src="RuneScore.png" alt="" /> <p id="runescore"></p></div>  
          <div className="grid-item-prof"><small>Rank:</small></div>
          <div className="grid-item-prof"><p id="runescore-rank"></p></div>

          
          <div className="grid-item-prof"><p>Total XP:</p></div>
          <div className="grid-item-prof"> <img src="skillsIcon.png" alt="" /> <p id="total-xp"></p></div>  
          <div className="grid-item-prof"><small>Rank:</small></div>
          <div className="grid-item-prof"><p id="total-xp-rank"></p></div>
  </div>
</div>
