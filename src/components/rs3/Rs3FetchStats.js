  ...
  return (
        ...
        <Table striped id="stat-table">
          ...
          <tbody>
            ...
            <tr>
              <td><img className="stat_icon" src={require("../../woodcut_stat_icons/25_summoning.png")} alt="Stats Symbol" />{new_array[24].name}</td>
              <td>{new_array[24].level}</td>
              <td>{new_array[24].xp}</td>
              <td>{new_array[24].rank}</td>
            </tr>
            <tr>
              <td><img className="stat_icon" src={require("../../woodcut_stat_icons/26_dungeoneering.png")} alt="Stats Symbol" />{new_array[25].name}</td>
              <td>{new_array[25].level}</td>
              <td>{new_array[25].xp}</td>
              <td>{new_array[25].rank}</td>
            </tr>
            <tr>
              <td><img className="stat_icon" src={require("../../woodcut_stat_icons/27_divination.png")} alt="Stats Symbol" />{new_array[26].name}</td>
              <td>{new_array[26].level}</td>
              <td>{new_array[26].xp}</td>
              <td>{new_array[26].rank}</td>
            </tr>
            <tr>
              <td><img className="stat_icon" src={require("../../woodcut_stat_icons/28_invention.png")} alt="Stats Symbol" />{new_array[27].name}</td>
